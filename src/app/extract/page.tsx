        ...
        <div className="flex h-full min-h-0 flex-col gap-3">
          <header className="flex shrink-0 flex-wrap items-center justify-between gap-3">
            <div className="flex min-w-0 flex-wrap items-center gap-2">
              ...
              <Badge variant="success" className="h-5 px-2 font-mono text-[10px]">
                {allData.length} line{allData.length === 1 ? "" : "s"}
              </Badge>
            ...
            <div className="flex shrink-0 items-center gap-2">
              ...
              <Button
                ...
                disabled={isPending}
                aria-label="Upload purchase order PDFs"
              >
          ...
          <section className="relative flex min-h-0 flex-1 flex-col overflow-hidden rounded-lg border border-[var(--border)] bg-[var(--surface)]">
            ...
            {allData.length === 0 ? (
              <div className="pointer-events-none absolute inset-0 grid place-items-center">
                <div className="flex max-w-[360px] flex-col items-center text-center">
                  <div className="relative mb-4 grid h-10 w-10 place-items-center rounded-full border border-[color-mix(in_oklch,var(--primary)_35%,var(--border))] bg-[color-mix(in_oklch,var(--primary)_10%,transparent)] text-[var(--primary)]">
                    <Inbox className="h-5 w-5" aria-hidden />
                    <span className="absolute -right-1 -top-1 grid h-5 w-5 place-items-center rounded-full border border-[color-mix(in_oklch,var(--primary)_35%,var(--border))] bg-[var(--surface)] text-[var(--primary)]">
                      <Plus className="h-3.5 w-3.5" aria-hidden />
                    </span>
                  </div>
                  <div className="text-[13px] font-semibold text-[var(--text)]">No PO lines yet</div>
                  <div className="mt-1 text-[11px] text-[var(--muted-foreground)]">
                    Upload purchase order PDFs to extract line items.
                  </div>
                </div>
              </div>
            ) : null}
            ...
            <div className="flex h-9 shrink-0 items-center justify-between border-t border-[var(--border)] bg-[var(--surface-elevated)] px-3 text-[11px] text-[var(--muted-foreground)]">
              ...
              <span className="font-mono text-[var(--muted-foreground)]">Ready for export</span>
            </div>
          </section>
        </div>
      </main>
